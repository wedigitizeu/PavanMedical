...
<body>
 <header class="app-header"><a class="app-header__logo" href="index.html"></a>
    ...
    <li><a class="app-menu__item active" href="bookings.php"><i class="app-menu__icon fa fa-handshake-o"></i><span class="app-menu__label">My Bookings</span></a></li>
    <li><a class="app-menu__item active" href="visitor-location.php"><i class="app-menu__icon fa fa-user-o"></i><span class="app-menu__label">Visitors</span></a></li>
